...
/** BtAdapterPlugin */
public class BtAdapterPlugin implements FlutterPlugin, MethodCallHandler {

  /// The MethodChannel that will the communication between Flutter and native Android
  ///
  /// This local reference serves to register the plugin with the Flutter Engine and unregister it
  /// when the Flutter Engine is detached from the Activity
  final String TAG = "BT Adapter";
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    channel = new MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "mybluetoothadapter");
    channel.setMethodCallHandler(this);
    connectionStatus = new EventChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "my_connection_status");
    connectionStatus.setStreamHandler(connectionStatusStreamHandler);
    receiveMessages = new EventChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "my_recieved_message_events");
    receiveMessages.setStreamHandler(receivedMessagesStreamHandler);
  }

  public static void registerWith(PluginRegistry.Registrar registrar) {
    context = registrar.context();
    BtAdapterPlugin flutterbluetoothadapterPlugin = new BtAdapterPlugin();
...
//                startActivityForResult(this, btEnabelingIntent, 1,null);
